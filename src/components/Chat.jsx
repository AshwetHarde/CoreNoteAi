...
export default function Chat({
  ...
  return (
    <div className="flex flex-col h-full max-h-[calc(100vh-120px)] sm:max-h-[calc(100vh-80px)] bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl transition-colors duration-300 rounded-2xl">
