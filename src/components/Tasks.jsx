...
function Tasks({
  ...
  return (
    <div className="flex flex-col h-full bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl transition-colors duration-300 rounded-2xl overflow-hidden">
